...
import Animated, { useAnimatedReaction, useSharedValue, useDerivedValue, runOnJS, interpolate, Extrapolation, runOnUI, cancelAnimation, useReducedMotion, ReduceMotion } from 'react-native-reanimated';
...
import { DEFAULT_ACCESSIBILITY_LABEL, DEFAULT_ACCESSIBILITY_ROLE, DEFAULT_ACCESSIBLE, DEFAULT_ANIMATE_ON_MOUNT, DEFAULT_DYNAMIC_SIZING, DEFAULT_ENABLE_BLUR_KEYBOARD_ON_GESTURE, DEFAULT_ENABLE_CONTENT_PANNING_GESTURE, DEFAULT_ENABLE_OVER_DRAG, DEFAULT_ENABLE_PAN_DOWN_TO_CLOSE, DEFAULT_KEYBOARD_BEHAVIOR, DEFAULT_KEYBOARD_BLUR_BEHAVIOR, DEFAULT_KEYBOARD_INPUT_MODE, DEFAULT_OVER_DRAG_RESISTANCE_FACTOR, INITIAL_POSITION, INITIAL_VALUE } from './constants';
...
const BottomSheetComponent = /*#__PURE__*/forwardRef(function BottomSheet(props, ref) {
  ...
  const animateToPosition = useCallback(function animateToPosition(position, source, velocity = 0, configs) {
     ...
     */
    let offset = 0;
    if (animatedKeyboardState.get().status === KEYBOARD_STATUS.SHOWN && keyboardBehavior !== KEYBOARD_BEHAVIOR.extend && position < animatedPosition.value) {
