 ...
 * ```
 */
export declare function useBottomSheetScrollableCreator<T = any>({ focusHook, scrollEventsHandlersHook, enableFooterMarginAdjustment, }?: BottomSheetScrollableCreatorConfigs): (props: T) => ReactElement<T>;
export {};
